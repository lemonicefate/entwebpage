...
// Clinic logo - flat illustration tribute (not the raster)
function ClinicMark({ size = 40 }) {
  return (
    <div style={{
      width: size, height: size, borderRadius: 10,
      background: 'linear-gradient(160deg, #5ba89f 0%, #4a9e94 100%)',
      display: 'grid', placeItems: 'center', position: 'relative',
      boxShadow: '0 1px 0 rgba(255,255,255,0.1) inset, 0 2px 6px rgba(15,42,66,0.25)',
    }}>
      <svg viewBox="0 0 40 40" width={size * 0.7} height={size * 0.7}>
        <path d="M17 8h6v8h8v6h-8v8h-6v-8H9v-6h8z" fill="#f2c94c"/>
        <circle cx="30" cy="10" r="2.6" fill="#e89661"/>
      </svg>
    </div>
  );
}
