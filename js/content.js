...
const CATEGORIES_BASE = [
  ...
  },
  {
    ...
    name: '過敏免疫',
    icon: 'Lungs',
    desc: '過敏性鼻炎、氣喘、異位性皮膚炎、蕁麻疹、自體免疫疾病',
    tone: '#a05cc2',
    toneCvd: '#CC79A7',
    topics: [
      { id: 'allergy-allergic-rhinitis', title: '過敏性鼻炎 (Allergic Rhinitis)', summary: '過敏性鼻炎是鼻黏膜接觸過敏原後產生的免疫反應，主要症狀為打噴嚏、流鼻水、鼻塞及鼻癢。', lastUpdated: '2026-04-05', contentPath: 'content/ent/ent-allergic-rhinitis.html' },
      { id: 'allergy-asthma-management-inhaler-guide', title: '氣喘 (Bronchial Asthma)', summary: '氣喘是一種慢性呼吸道發炎疾病，台灣約 10% 的成人受其困擾。本文說明急性發作的處置步驟、吸入劑的 5 大常見操作錯誤，以及如何透過居家環境改造減少誘發因子，讓氣喘真正得到控制。', lastUpdated: '2026-04-22', contentPath: 'content/internal/internal-asthma-management-inhaler-guide.html' },
      { id: 'allergy-atopic-dermatitis-infant', title: '嬰幼兒異位性皮膚炎 (Atopic Dermatitis / Infantile Eczema)', summary: '異位性皮膚炎是台灣最常見的嬰幼兒慢性皮膚病，影響約一成兒童，60% 在一歲前發病。文章說明症狀辨識、居家照護重點（正確泡澡與保濕技巧）、用藥原則，以及何時需要到診所進一步評估與治療。', lastUpdated: '2026-04-08', contentPath: 'content/pediatric/pediatric-atopic-dermatitis-infant.html' },
      { id: 'allergy-urticaria', title: '急性與慢性蕁麻疹 (Urticaria / Hives)', summary: '蕁麻疹（風疹塊）是皮膚突然出現的紅色隆起疹子，癢到令人崩潰。急性蕁麻疹多由過敏引起，通常數天內消退；但若反覆發作超過六週，就進入「慢性蕁麻疹」，需要系統性治療策略。本文帶你看懂原因、治療步驟與何時該就醫。', lastUpdated: '2026-04-21', contentPath: 'content/ent/ent-urticaria.html' },
      { id: 'allergy-systemic-lupus-erythematosus', title: '全身性紅斑性狼瘡 (Systemic Lupus Erythematosus, SLE)', summary: '紅斑性狼瘡是一種免疫系統攻擊自身組織的慢性疾病，好發於年輕女性。蝴蝶狀臉部紅斑是最具代表性的症狀，但它同時可能影響腎臟、心臟、神經系統等全身器官。本文說明如何辨識症狀、何時就醫，以及現代治療如何幫助你穩定控制病情。', lastUpdated: '2026-04-24', contentPath: 'content/internal/internal-systemic-lupus-erythematosus.html' },
    ],
  },
  {
    id: 'infect',
    name: '感染症',
    icon: 'Virus',
    desc: '流感、登革熱、帶狀疱疹、腺病毒、腸病毒、諾羅、玫瑰疹、哮吼',
    tone: '#1f8e84',
    toneCvd: '#009E73',
    topics: [
      { id: 'infect-influenza-vs-cold-antiviral', title: '流行性感冒 (Influenza)', summary: '流感與感冒症狀相似，但嚴重程度天差地遠。突然高燒、全身痠痛、極度疲倦是流感的警報訊號。抗病毒藥在發病 48 小時內使用效果最佳，超過時限效力大幅下降。學會辨別，掌握黃金治療時機，保護自己與家人。', lastUpdated: '2026-04-25', contentPath: 'content/ent/ent-influenza-vs-cold-antiviral.html' },
      { id: 'infect-dengue-fever-prevention', title: '登革熱 (Dengue Fever)', summary: '登革熱由埃及斑蚊傳播，台灣每年夏秋季都可能爆發本土疫情。突然高燒、全身痠痛是典型症狀；退燒後 24-48 小時反而是最危險的階段。掌握警示症狀、落實「巡倒清刷」環境防蚊，才是最有效的保護策略。', lastUpdated: '2026-04-26', contentPath: 'content/ent/ent-dengue-fever-prevention.html' },
      { id: 'infect-herpes-zoster-shingles', title: '帶狀疱疹 (Herpes Zoster / Shingles)', summary: '帶狀疱疹（俗稱「皮蛇」）是水痘病毒潛伏多年後的再活化，以單側皮節性劇痛與水泡為特徵，可能引發長達數年的神經痛，甚至侵犯耳朵與眼睛。及早接種疫苗、48–72 小時內開始抗病毒藥物，是避免後遺症的關鍵。', lastUpdated: '2026-04-23', contentPath: 'content/ent/ent-herpes-zoster-shingles.html' },
      { id: 'infect-adenovirus-fever-children', title: '腺病毒感染 (Adenovirus Infection)', summary: '腺病毒是兒童高燒最常見的元兇之一，體溫常超過 39°C 且可持續 5–10 天，俗稱「燒久姬」。除了高燒，還常合併眼睛紅、喉嚨痛、腸胃不適等多重症狀。目前無特效藥，了解正確的居家照護與就醫時機，是陪孩子安全度過病程的關鍵。', lastUpdated: '2026-04-07', contentPath: 'content/pediatric/pediatric-adenovirus-fever-children.html' },
      { id: 'infect-enterovirus', title: '腸病毒感染 (Enterovirus Infection)', summary: '腸病毒是台灣每年春末夏初的兒童公敵，多數孩子 7-10 天可自行恢復，但少數會演變成腦炎等重症。這篇文章教你辨識重症前兆、做好居家隔離，以及何時該直奔急診。', lastUpdated: '2026-04-07', contentPath: 'content/pediatric/pediatric-enterovirus.html' },
      { id: 'infect-norovirus-rotavirus-hydration', title: '諾羅病毒與輪狀病毒腸胃炎 (Norovirus & Rotavirus Gastroenteritis)', summary: '孩子突然上吐下瀉，是諾羅還是輪狀？兩種病毒都沒有特效藥，關鍵在於「補水」。本文帶你認識兩種病毒的差異、脫水的警示徵兆，以及正確的補水與飲食策略，讓孩子早日恢復。', lastUpdated: '2026-04-11', contentPath: 'content/pediatric/pediatric-norovirus-rotavirus-hydration.html' },
      { id: 'infect-roseola-infantum', title: '玫瑰疹 (Roseola Infantum / Exanthem Subitum)', summary: '玫瑰疹是嬰幼兒最常見的病毒感染之一，特徵是高燒 3-4 天、退燒後全身出現粉紅色皮疹。了解其病程、熱性痙攣的處理方式，以及何時需要立即就醫，幫助爸媽冷靜應對這個常見但讓人心驚的疾病。', lastUpdated: '2026-04-09', contentPath: 'content/pediatric/pediatric-roseola-infantum.html' },
      { id: 'infect-croup', title: '哮吼 (Croup / Laryngotracheobronchitis)', summary: '哮吼是好發於嬰幼兒的病毒性上呼吸道感染，最典型的症狀是像海豹叫聲的犬吠咳嗽。大多數孩子屬輕症，可在家照護；但出現安靜時喘鳴或呼吸費力，就需要立即就醫。', lastUpdated: '2026-04-07', contentPath: 'content/pediatric/pediatric-croup.html' },
    ],
  },
  {
    id: 'ortho',
  ...
  },
  {
    ...
    name: '耳鼻喉專科',
    icon: 'Stethoscope',
    desc: '中耳炎、鼻竇炎、眩暈、耳鳴、睡眠呼吸中止症',
    tone: '#0e7c7b',
    toneCvd: '#0e7c7b',
    topics: [
      { id: 'ent-sinusitis', title: '鼻竇炎 (Sinusitis / Rhinosinusitis)', summary: '鼻塞、頭痛加上黃綠色鼻涕，你可能以為只是感冒，但這些症狀持續超過一週，小心可能是鼻竇炎！本文帶你認識急性與慢性鼻竇炎的差異、正確治療方式，以及什麼時候需要做進一步檢查。', lastUpdated: '2026-04-06', contentPath: 'content/ent/ent-sinusitis.html' },
      { id: 'ent-lpr-chronic-pharyngitis', title: '逆流性咽喉炎 (Laryngopharyngeal Reflux, LPR)', summary: '喉嚨有異物感、常常需要清喉嚨、聲音沙啞——這些症狀合稱「慢性咽喉炎」，很多時候是胃酸逆流到咽喉（LPR）引起的。了解成因、調整生活習慣，多數人都能有效改善。', lastUpdated: '2026-04-06', contentPath: 'content/ent/ent-lpr-chronic-pharyngitis.html' },
...
const HERO_MONTHLY = {
  ...
  3: {
    ...
    title: '春天來了，\n鼻子又開始造反？',
    author: '李名弘 醫師', readingMinutes: 5,
    href: '#/allergy/allergy-allergic-rhinitis',
  },
  4: {
    eyebrow: '春季過敏 · 四月',
    title: '鼻塞頭痛超過一週，\n小心是鼻竇炎',
  ...
  5: {
    ...
    href: '#/infect/infect-enterovirus',
  },
  6: {
    eyebrow: '兒童健康 · 六月',
    title: '發燒五天退不了？\n腺病毒「燒久姬」攻略',
    author: '洪千惠 醫師', readingMinutes: 6,
    href: '#/infect/infect-adenovirus-fever-children',
  },
  7: {
    eyebrow: '暑期腸胃 · 七月',
    title: '上吐下瀉來得急，\n補水才是關鍵',
    author: '洪千惠 醫師', readingMinutes: 5,
    href: '#/infect/infect-norovirus-rotavirus-hydration',
  },
  8: {
    eyebrow: '暑期兒童 · 八月',
    title: '開學前，\n認識孩子的生長曲線',
  ...
  9: {
    ...
    title: '喉嚨老是有痰，\n可能是胃酸在作怪',
    author: '李名弘 醫師', readingMinutes: 5,
    href: '#/ent/ent-lpr-chronic-pharyngitis',
  },
  10: {
    eyebrow: '秋季睡眠 · 十月',
    title: '打呼不是睡好，\n可能是呼吸在夜間暫停',
